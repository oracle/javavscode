...
export type InternalResolverDebugConfigurationBase = {
    type: typeof extConstants.COMMAND_PREFIX;
    __internalConfigurationResolver: boolean;
    __resolverRequestId: string;
    __resolverValues: ResolverValueMap;
};

export type InternalResolverDebugConfiguration = DebugConfiguration & InternalResolverDebugConfigurationBase;
