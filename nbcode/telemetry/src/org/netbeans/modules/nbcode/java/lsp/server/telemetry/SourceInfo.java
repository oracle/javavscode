...
class SourceInfo {
    ...
    public LanguageClient getLanguageClient() {
        ...
        if (client == null) {
            client = lookupInstance(LanguageClient.class);
            if (client != null)
    ...
    public String getJavaVersion() {
        final JavaPlatformProvider lookup = lookupInstance(JavaPlatformProvider.class);
        Function<String, String> lookupFunction;
        if (lookup == null) {
            lookupFunction = System::getProperty;
        } else {
            final JavaPlatform defaultPlatform = lookup.getDefaultPlatform();
            final Map<String, String> systemProperties = defaultPlatform == null ? null : defaultPlatform.getSystemProperties();
            lookupFunction = systemProperties == null ? System::getProperty : systemProperties::get;
        }
    ...
    private <V> V lookupInstance(Class<V> type) {
        V instance = null;
        if (owner != null) {
            instance = owner.getLookup().lookup(type);
        }
        if (instance == null) {
            instance = Lookup.getDefault().lookup(type);
        }
        return instance;
    }
